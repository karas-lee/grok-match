...
### 4.3 그룹별 평가기
- [ ] GroupEvaluator.java (인터페이스)
- [ ] FirewallEvaluator.java
- [ ] WebServerEvaluator.java
- [ ] SystemEvaluator.java
...
### 5.1 추천 서비스
- [ ] LogFormatRecommender.java (인터페이스)
